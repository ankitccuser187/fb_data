# -*- coding: utf-8 -*-
"""
Created on Thu Sep 24 23:25:55 2015
...
def fetch_fb_details(user_details, username, passwd):
    ...
    logiun_url = "https://www.facebook.com"
    ...
    for each_user in user_details:
        try:
            ...
            find_url = "https://www.facebook.com/search/str/results/?q=" + each_user
    ...
    writer = csv.writer(open("user_details.csv", "ab"),delimiter=',')
